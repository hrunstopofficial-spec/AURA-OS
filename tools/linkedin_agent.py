...
2. Structure:
   ...
   - Closing Question / CTA: Invite peers to share thoughts or check out the code.
...
def main():
    ...
    if args.dry_run:
        print("[*] Dry-run enabled. Post was not published to LinkedIn.")
        return
    ...
    if should_post:
        ...
        result = post_to_linkedin(post_content, image_path=args.image)
